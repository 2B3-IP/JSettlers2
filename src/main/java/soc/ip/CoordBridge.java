...
public class CoordBridge {
    ...
    static {
        ...
        // === Edges confirmed manually by user ===
        edges.put(34, Arrays.asList(new HexPosition(-2, 0), new HexPosition(999, 999)));
        edges.put(36, Arrays.asList(new HexPosition(-1, -1), new HexPosition(999, 999)));
        edges.put(37, Arrays.asList(new HexPosition(-1, -1), new HexPosition(999, 999)));
        edges.put(50, Arrays.asList(new HexPosition(-2, 0), new HexPosition(999, 999)));
        edges.put(54, Arrays.asList(new HexPosition(0, -2), new HexPosition(-1, -1)));
        edges.put(66, Arrays.asList(new HexPosition(-2, 1), new HexPosition(999, 999)));
        ...
        edges.put(82, Arrays.asList(new HexPosition(-2, 1), new HexPosition(999, 999)));
        ...
        edges.put(98, Arrays.asList(new HexPosition(-2, 2), new HexPosition(999, 999)));
        ...
        edges.put(120, Arrays.asList(new HexPosition(-1, 0), new HexPosition(0, -1)));
        edges.put(122, Arrays.asList(new HexPosition(1, -1), new HexPosition(2, -2)));
        edges.put(131, Arrays.asList(new HexPosition(-2, 2), new HexPosition(999, 999)));
        ...
        edges.put(156, Arrays.asList(new HexPosition(2, -1), new HexPosition(999, 999)));
        edges.put(165, Arrays.asList(new HexPosition(-1, 2), new HexPosition(999, 999)));
        ...
        edges.put(171, Arrays.asList(new HexPosition(0, 0), new HexPosition(0, -1)));
        edges.put(172, Arrays.asList(new HexPosition(2, -1), new HexPosition(999, 999)));
        edges.put(182, Arrays.asList(new HexPosition(0, 2), new HexPosition(999, 999)));
        ...
        edges.put(188, Arrays.asList(new HexPosition(2, 0), new HexPosition(999, 999)));
        edges.put(199, Arrays.asList(new HexPosition(0, 2), new HexPosition(999, 999)));
